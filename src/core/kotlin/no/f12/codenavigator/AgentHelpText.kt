...
object AgentHelpText {
    ...
    private fun generateWorkflow(tool: BuildTool): String = buildString {
        ...
        appendLine("   ${u("find-callers", p("pattern", "resetPassword"), p("maxdepth", "3"), p("projectonly", "true"))}  # who calls this?")
        appendLine("   ${u("find-callees", p("pattern", "handleRequest"), p("maxdepth", "3"), p("projectonly", "false"))}  # what does this call?")
