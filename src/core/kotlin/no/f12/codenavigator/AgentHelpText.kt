...
object AgentHelpText {
    fun generate(tool: BuildTool = BuildTool.GRADLE): String = buildString {
        ...
        appendLine("   ${u("complexity", p("class", "Service"))}       # fan-in/out for matching classes")
        appendLine("   ${u("complexity", p("class", "\".*Controller\""), p("detail", "true"))} # with call details")
        appendLine("   ${u("complexity", p("class", "\"domain\\\\..*\""), p("projectonly", "false"))} # include external")
        appendLine()
        ...
        appendLine("  ${t("complexity")}            Class fan-in/fan-out        ${p("class", "<pattern>")} [${p("projectonly", "true")}] [${p("detail", "true")}]")
        appendLine()
        ...
        appendLine("  ${p("class", "<pattern>")}         Class name regex to analyze (${t("complexity")})")
